<?php
include 'Form/booking_confirmed_form.php'; // Include your database connection file
?>
...
<head>
    ...
    <script src="../../../JS/Transaction/booking_confirmed.js"></script>
            ...
            <div class="confirmed-container">
                <div class="checkmark">
                    <svg viewBox="0 0 100 100">
                        <path d="M30 50l20 20 40-40" />
                    </svg>
                </div>
                <p class="confirm-heading">Booking successfully confirmed!</p>
                <a class="back-transaction" href="../booking.php">back to transaction</a>
            </div>
        </div>
    </div>
</body>
