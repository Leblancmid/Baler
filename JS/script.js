...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const canvas = new fabric.Canvas('image-preview');

  // Add event listeners to the crop and rotate buttons
  cropButton.addEventListener('click', () => {
    ...
    // Add the cropping rectangle to the canvas
    canvas.add(rect);

    // Set the image object's crop rectangle
