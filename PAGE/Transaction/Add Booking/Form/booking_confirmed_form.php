...
$stmt = $conn->prepare("INSERT INTO bookings (reference_no, rooms, room_pax, amenities, first_name, last_name, email, contact, address, total, additional_pax, check_in, check_out, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
